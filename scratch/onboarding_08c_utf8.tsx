...
const IBAN_CONFIGS: Record<string, IbanConfig> = {
  DZ: { prefix: 'DZ', length: 24, placeholder: 'DZ0000000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (IBAN ╪¼╪▓╪º╪ª╪▒┘è)', labelEn: 'Algerian IBAN' },
  SA: { prefix: 'SA', length: 24, placeholder: 'SA0000000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (IBAN ╪│╪╣┘ê╪»┘è)', labelEn: 'Saudi IBAN' },
  TN: { prefix: 'TN', length: 24, placeholder: 'TN0000000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (IBAN ╪¬┘ê┘å╪│┘è)', labelEn: 'Tunisian IBAN' },
  MA: { prefix: 'MA', length: 28, placeholder: 'MA00000000000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (RIB ┘à╪║╪▒╪¿┘è)', labelEn: 'Moroccan RIB' },
  AE: { prefix: 'AE', length: 23, placeholder: 'AE000000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (IBAN ╪Ñ┘à╪º╪▒╪º╪¬┘è)', labelEn: 'UAE IBAN' },
  EG: { prefix: 'EG', length: 29, placeholder: 'EG00000000000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (IBAN ┘à╪╡╪▒┘è)', labelEn: 'Egyptian IBAN' },
  default: { prefix: '', length: 34, placeholder: 'XX0000000000000000000', labelAr: '╪▒┘é┘à ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪»┘ê┘ä┘è (IBAN)', labelEn: 'IBAN (15-34 chars)' },
};
...
const FINANCE_CONFIGS: Record<string, CountryFinanceConfig> = {
  DZ: {
    ...
    docs: [
      { id: 'bank_account', labelAr: '┘â╪┤┘ü ╪¡╪│╪º╪¿ ╪¿┘å┘â┘è CCP ╪ú┘ê ╪¿╪▒┘è╪»┘è', labelEn: 'CCP / Postal bank statement', optional: false },
      { id: 'baridimob', labelAr: '╪Ñ╪½╪¿╪º╪¬ ╪¡╪│╪º╪¿ ╪¿╪▒┘è╪»┘è ┘à┘ê╪¿ BaridiMob', labelEn: 'BaridiMob account proof', optional: true },
      { id: 'bank_cert', labelAr: '╪┤┘ç╪º╪»╪⌐ ╪¿┘å┘â┘è╪⌐ (╪º╪«╪¬┘è╪º╪▒┘è)', labelEn: 'Bank certificate (optional)', optional: true },
    ],
    notes: [
      { ar: '┘è┘à┘â┘å┘â ╪¬┘é╪»┘è┘à ┘â╪┤┘ü ╪¡╪│╪º╪¿ CCP ╪ú┘ê ╪¡╪│╪º╪¿ ╪¿┘å┘â┘è ╪╣╪º╪»┘è', en: 'You can provide a CCP or regular bank statement' },
      { ar: '╪¡╪│╪º╪¿ BaridiMob ┘à┘é╪¿┘ê┘ä ┘â┘ê╪│┘è┘ä╪⌐ ╪»┘ü╪╣ ╪¿╪»┘è┘ä╪⌐', en: 'BaridiMob account is accepted as an alternative payment method' },
    ],
  },
  SA: {
    iban: IBAN_CONFIGS.SA,
    docs: [
      { id: 'bank_letter', labelAr: '╪┤┘ç╪º╪»╪⌐ ╪¿┘å┘â┘è╪⌐ / ╪«╪╖╪º╪¿ ╪¿┘å┘â┘è', labelEn: 'Bank certificate / letter', optional: false },
      { id: 'bank_account', labelAr: '┘â╪┤┘ü ╪¡╪│╪º╪¿ ╪¿┘å┘â┘è', labelEn: 'Bank statement', optional: true },
    ],
    notes: [
      { ar: '┘è╪¼╪¿ ╪ú┘å ┘è┘â┘ê┘å IBAN ╪¿╪╡┘è╪║╪⌐ ╪│╪╣┘ê╪»┘è╪⌐ (SA + 22 ╪▒┘é┘à)', en: 'IBAN must be in Saudi format (SA + 22 digits)' },
    ],
  },
  TN: {
    iban: IBAN_CONFIGS.TN,
    docs: [
      { id: 'bank_rib', labelAr: '┘â╪┤┘ü RIB ╪¿┘å┘â┘è', labelEn: 'Bank RIB statement', optional: false },
      { id: 'bank_cert', labelAr: '╪┤┘ç╪º╪»╪⌐ ╪¿┘å┘â┘è╪⌐ (╪º╪«╪¬┘è╪º╪▒┘è)', labelEn: 'Bank certificate (optional)', optional: true },
    ],
    notes: [
      { ar: 'RIB ╪¿╪╡┘è╪║╪⌐ ╪¬┘ê┘å╪│┘è╪⌐ (TN + 22 ╪▒┘é┘à)', en: 'RIB in Tunisian format (TN + 22 digits)' },
    ],
  },
  MA: {
    iban: IBAN_CONFIGS.MA,
    docs: [
      { id: 'bank_rib', labelAr: '┘â╪┤┘ü RIB ╪¿┘å┘â┘è ┘à╪║╪▒╪¿┘è', labelEn: 'Moroccan RIB statement', optional: false },
    ],
    notes: [
      { ar: 'RIB ╪¿╪╡┘è╪║╪⌐ ┘à╪║╪▒╪¿┘è╪⌐ (MA + 24 ╪▒┘é┘à)', en: 'RIB in Moroccan format (MA + 24 digits)' },
    ],
  },
  default: {
    iban: IBAN_CONFIGS.default,
    docs: [
      { id: 'bank_account', labelAr: '┘â╪┤┘ü ╪¡╪│╪º╪¿ ╪¿┘å┘â┘è', labelEn: 'Bank statement', optional: false },
    ],
    notes: [],
  },
};
...
function getSteps(role: UserRole): StepDef[] {
  switch (role) {
    case 'store_manager':
      return [
        { titleAr: '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä┘é╪º┘å┘ê┘å┘è', titleEn: 'Legal Verification', icon: <FileText className="h-4 w-4" /> },
        { titleAr: '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä┘à╪º┘ä┘è', titleEn: 'Financial Verification', icon: <Shield className="h-4 w-4" /> },
        { titleAr: '╪¬┘ê╪½┘è┘é ╪º┘ä┘ç┘ê┘è╪⌐', titleEn: 'Identity Verification', icon: <User className="h-4 w-4" /> },
      ];
    case 'seller':
      return [
        { titleAr: '╪Ñ╪½╪¿╪º╪¬ ╪º┘ä╪ú┘ç┘ä┘è╪⌐', titleEn: 'Eligibility Proof', icon: <FileText className="h-4 w-4" /> },
        { titleAr: '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä╪¿┘è┘ê┘à╪¬╪▒┘è', titleEn: 'Biometric Verification', icon: <ScanFace className="h-4 w-4" /> },
        { titleAr: '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä┘à╪º┘ä┘è', titleEn: 'Financial Verification', icon: <Shield className="h-4 w-4" /> },
      ];
    case 'supplier':
      return [
        { titleAr: '╪º┘ä╪¬╪▒╪º╪«┘è╪╡ ╪º┘ä╪¬╪¼╪º╪▒┘è╪⌐', titleEn: 'Commercial Licenses', icon: <FileText className="h-4 w-4" /> },
        { titleAr: '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä┘à╪º┘ä┘è', titleEn: 'Financial Verification', icon: <Shield className="h-4 w-4" /> },
      ];
    case 'logistics':
      return [
        { titleAr: '╪º┘ä╪¬╪▒╪º╪«┘è╪╡', titleEn: 'Licenses', icon: <FileText className="h-4 w-4" /> },
        { titleAr: '┘à╪╣┘ä┘ê┘à╪º╪¬ ╪º┘ä╪ú╪│╪╖┘ê┘ä', titleEn: 'Fleet Information', icon: <Truck className="h-4 w-4" /> },
      ];
    case 'admin':
      return [];
    case 'buyer':
  ...
  const handleFile = useCallback(
    async (file: File) => {
      if (file.size > maxSizeMB * 1024 * 1024) {
        toast.error(t(locale, `╪¡╪¼┘à ╪º┘ä┘à┘ä┘ü ┘â╪¿┘è╪▒ ╪¼╪»╪º┘ï. ╪º┘ä╪¡╪» ╪º┘ä╪ú┘é╪╡┘ë ${maxSizeMB}MB`, `File too large. Max ${maxSizeMB}MB`));
        return;
      }
      ...
      try {
        ...
        if (!res.ok) {
          ...
          toast.error(
            (errData as { error?: string }).error || t(locale, '┘ü╪┤┘ä ╪▒┘ü╪╣ ╪º┘ä┘à┘ä┘ü', 'Upload failed')
          );
          return;
        }
        ...
        if (data.success && data.url) {
          ...
          toast.error(
            data.error || t(locale, '┘ü╪┤┘ä ╪▒┘ü╪╣ ╪º┘ä┘à┘ä┘ü', 'Upload failed')
          );
        }
      } catch (err) {
        console.error('[FileUpload] Error:', err);
        if (err instanceof DOMException && err.name === 'AbortError') {
          toast.error(t(locale, '╪º┘å╪¬┘ç╪¬ ┘à┘ç┘ä╪⌐ ╪º┘ä╪▒┘ü╪╣. ╪¡╪º┘ê┘ä ┘à╪▒╪⌐ ╪ú╪«╪▒┘ë.', 'Upload timed out. Try again.'));
        } else {
          toast.error(
            t(locale, '╪«╪╖╪ú ┘ü┘è ╪º┘ä╪º╪¬╪╡╪º┘ä. ╪¬╪¡┘é┘é ┘à┘å ╪º┘ä╪Ñ┘å╪¬╪▒┘å╪¬ ┘ê╪¡╪º┘ê┘ä ┘à╪▒╪⌐ ╪ú╪«╪▒┘ë.', 'Connection error. Check your internet and try again.')
          );
        }
      } finally {
    ...
    <div className="space-y-2">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground text-center">
          {t(locale, '╪º╪│╪¡╪¿ ╪º┘ä┘à┘ä┘ü ┘ç┘å╪º ╪ú┘ê ╪º┘å┘é╪▒ ┘ä┘ä╪▒┘ü╪╣', 'Drag file or click to upload')}
        </p>
...
export default function OnboardingWizard() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!authUser) {
        ...
        toast.error(t(locale, '╪«╪╖╪ú: ┘ä┘à ┘è╪¬┘à ╪º┘ä╪╣╪½┘ê╪▒ ╪╣┘ä┘ë ╪¿┘è╪º┘å╪º╪¬ ╪º┘ä┘à╪│╪¬╪«╪»┘à. ┘è╪▒╪¼┘ë ╪Ñ╪╣╪º╪»╪⌐ ╪¬╪│╪¼┘è┘ä ╪º┘ä╪»╪«┘ê┘ä.', 'Error: User data not found. Please log in again.'));
        return;
      }
      ...
      if (role === 'seller' && !freelancerIban) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪Ñ╪»╪«╪º┘ä ╪▒┘é┘à IBAN ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ┘ü┘è ╪º┘ä╪«╪╖┘ê╪⌐ ╪º┘ä┘à╪º┘ä┘è╪⌐', 'Please enter your bank IBAN in the financial step');
      } else if (role === 'store_manager' && (!commercialRegisterNumber || !commercialRegisterFile)) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪Ñ┘â┘à╪º┘ä ╪¿┘è╪º┘å╪º╪¬ ╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è', 'Please complete the commercial register information');
      } else if (role === 'store_manager' && (!iban || !beneficiaryName)) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪Ñ╪»╪«╪º┘ä ╪¿┘è╪º┘å╪º╪¬ ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è', 'Please enter bank account details');
      } else if (role === 'store_manager' && (!idFrontFile || !idBackFile)) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪▒┘ü╪╣ ╪╡┘ê╪▒ ╪º┘ä┘ç┘ê┘è╪⌐', 'Please upload ID photos');
      } else if (role === 'supplier' && (!commercialLicenseFile || !importLicenseFile)) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪▒┘ü╪╣ ╪º┘ä╪¬╪▒╪º╪«┘è╪╡ ╪º┘ä╪¬╪¼╪º╪▒┘è╪⌐', 'Please upload commercial licenses');
      } else if (role === 'supplier' && !supplierIban) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪Ñ╪»╪«╪º┘ä ╪▒┘é┘à IBAN', 'Please enter bank IBAN');
      } else if (role === 'logistics' && (!transportLicenseFile || !insuranceCertificateFile)) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪▒┘ü╪╣ ╪▒╪«╪╡╪⌐ ╪º┘ä┘å┘é┘ä ┘ê╪┤┘ç╪º╪»╪⌐ ╪º┘ä╪¬╪ú┘à┘è┘å', 'Please upload transport license and insurance');
      } else if (role === 'logistics' && (!numberOfVehicles || !numberOfDrivers)) {
        missingMsg = t(locale, '┘è╪▒╪¼┘ë ╪Ñ╪»╪«╪º┘ä ╪╣╪»╪» ╪º┘ä┘à╪▒┘â╪¿╪º╪¬ ┘ê╪º┘ä╪│╪º╪ª┘é┘è┘å', 'Please enter number of vehicles and drivers');
      }
      ...
      try {
        ...
        if (data.success) {
          ...
          submitForReview();
          toast.success(t(locale, '╪¬┘à ╪Ñ╪▒╪│╪º┘ä ╪╖┘ä╪¿┘â ┘ä┘ä┘à╪▒╪º╪¼╪╣╪⌐', 'Application submitted for review'));
        } else {
          const errorMsg = data.error
            || (data.missingFields
              ? t(locale, `╪¡┘é┘ê┘ä ┘à┘ü┘é┘ê╪»╪⌐: ${data.missingFields.join('╪î ')}`, `Missing fields: ${data.missingFields.join(', ')}`)
              : t(locale, '┘ü╪┤┘ä ╪Ñ╪▒╪│╪º┘ä ╪º┘ä╪╖┘ä╪¿', 'Failed to submit application'));
          toast.error(errorMsg);
        }
      } catch (fetchErr: unknown) {
        if (fetchErr instanceof DOMException && fetchErr.name === 'AbortError') {
          toast.error(t(locale, '╪º┘å╪¬┘ç╪¬ ┘à┘ç┘ä╪⌐ ╪º┘ä╪Ñ╪▒╪│╪º┘ä. ╪¬╪¡┘é┘é ┘à┘å ╪º╪¬╪╡╪º┘ä┘â ┘ê╪¡╪º┘ê┘ä ┘à╪▒╪⌐ ╪ú╪«╪▒┘ë.', 'Request timed out. Check your connection and try again.'));
        } else {
          console.error('[handleSubmit] Fetch error:', fetchErr);
          toast.error(t(locale, '╪¡╪»╪½ ╪«╪╖╪ú ╪ú╪½┘å╪º╪í ╪Ñ╪▒╪│╪º┘ä ╪º┘ä╪╖┘ä╪¿. ┘è╪▒╪¼┘ë ╪º┘ä┘à╪¡╪º┘ê┘ä╪⌐ ┘à╪▒╪⌐ ╪ú╪«╪▒┘ë.', 'An error occurred while submitting. Please try again.'));
        }
      } finally {
        clearTimeout(timeout);
        setIsSubmitting(false);
      ...
      setIsSubmitting(false);
      toast.error(t(locale, '╪¡╪»╪½ ╪«╪╖╪ú ╪║┘è╪▒ ┘à╪¬┘ê┘é╪╣', 'An unexpected error occurred'));
    }
  };
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      const draftTimeout = setTimeout(() => draftController.abort(), 20000);
      ...
      <div className="space-y-2">
        ...
        {hasError && (
          <p className="text-xs text-destructive flex items-center gap-1">
            ...
            {ibanConfig.prefix
              ? t(locale, `┘è╪¼╪¿ ╪ú┘å ┘è╪¿╪»╪ú ╪¿┘Ç ${ibanConfig.prefix} ┘ê┘è┘â┘ê┘å ${ibanConfig.length} ╪¡╪▒┘ü`, `Must start with ${ibanConfig.prefix} and be ${ibanConfig.length} characters`)
              : t(locale, 'IBAN ╪║┘è╪▒ ╪╡╪º┘ä╪¡ (15-34 ╪¡╪▒┘ü: ╪¡╪▒┘ü╪º┘å + ╪ú╪▒┘é╪º┘à)', 'Invalid IBAN (15-34 chars: 2 letters + digits)')
            }
          </p>
        )}
        {showSuccess && (
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä┘é╪º┘å┘ê┘å┘è', 'Legal Verification')}
                </h3>
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è ┘ê┘ê╪½╪º╪ª┘é ╪º┘ä╪¬╪ú╪│┘è╪│', 'Commercial register & incorporation docs')}
                </p>
              </div>
            </div>
            <div className="space-y-2">
              <Label className="text-sm font-medium">
                {t(locale, '╪▒┘é┘à ╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è', 'Commercial Register Number')}
              </Label>
              <Input
                placeholder={t(locale, '╪ú╪»╪«┘ä ╪▒┘é┘à ╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è (10 ╪ú╪▒┘é╪º┘à)', 'Enter CR number (10 digits)')}
                maxLength={10}
              ...
              {commercialRegisterNumber.length > 0 && commercialRegisterNumber.length !== 10 && (
                <p className="text-xs text-destructive flex items-center gap-1">
                  <AlertCircle className="h-3 w-3" />
                  {t(locale, '┘è╪¼╪¿ ╪ú┘å ┘è┘â┘ê┘å ╪º┘ä╪▒┘é┘à ┘à┘â┘ê┘å ┘à┘å 10 ╪ú╪▒┘é╪º┘à', 'Must be exactly 10 digits')}
                </p>
              )}
            </div>
            <FileUploadZone
              label="┘ê╪½┘è┘é╪⌐ ╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è"
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä┘à╪º┘ä┘è', 'Financial Verification')}
                </h3>
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ┘ê╪º┘ä┘ê╪½╪º╪ª┘é ╪º┘ä┘à╪º┘ä┘è╪⌐', 'Bank account & financial documents')}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium">
                {t(locale, '╪º╪│┘à ╪º┘ä┘à╪│╪¬┘ü┘è╪»', 'Beneficiary Name')}
              </Label>
              <Input
                placeholder={t(locale, '╪º┘ä╪º╪│┘à ┘â┘à╪º ┘ü┘è ╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è', 'Name as on bank account')}
                value={beneficiaryName}
                onChange={(e) => setField('beneficiaryName', e.target.value)}
              />
            </div>
            <FileUploadZone
              label={financeConfig.docs[0]?.labelAr || t(locale, '┘â╪┤┘ü ╪¡╪│╪º╪¿ ╪¿┘å┘â┘è', 'Bank Statement')}
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪¬┘ê╪½┘è┘é ╪º┘ä┘ç┘ê┘è╪⌐', 'Identity Verification')}
                </h3>
                <p className="text-xs text-muted-foreground">
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪Ñ╪½╪¿╪º╪¬ ╪º┘ä╪ú┘ç┘ä┘è╪⌐', 'Eligibility Proof')}
                </h3>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="flex flex-col items-center gap-2 pt-2">
              <p className="text-xs text-muted-foreground">
                {t(locale, '┘ç╪░┘ç ╪º┘ä╪«╪╖┘ê╪⌐ ╪º╪«╪¬┘è╪º╪▒┘è╪⌐', 'This step is optional')}
              </p>
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪º┘ä╪¬┘ê╪½┘è┘é ╪º┘ä╪¿┘è┘ê┘à╪¬╪▒┘è', 'Biometric Verification')}
                </h3>
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪º┘ä┘ç┘ê┘è╪⌐ + ╪º┘ä╪¬╪¡┘é┘é ╪º┘ä╪¡┘è', 'Identity + Liveness Detection')}
                </p>
              </div>
            </div>
          ...
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ╪º┘ä╪┤╪«╪╡┘è', 'Personal bank account')}
                </p>
              </div>
            </div>
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪º┘ä╪¬╪▒╪º╪«┘è╪╡ ╪º┘ä╪¬╪¼╪º╪▒┘è╪⌐', 'Commercial Licenses')}
                </h3>
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪▒╪«╪╡╪⌐ ╪¬╪¼╪º╪▒┘è╪⌐ + ╪▒╪«╪╡╪⌐ ╪º╪│╪¬┘è╪▒╪º╪»', 'Commercial license + Import license')}
                </p>
              </div>
            </div>
            <FileUploadZone
          ...
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪º┘ä╪¡╪│╪º╪¿ ╪º┘ä╪¿┘å┘â┘è ┘ä┘ä┘à┘ê╪▒╪»', 'Supplier bank account')}
                </p>
              </div>
            </div>
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '╪º┘ä╪¬╪▒╪º╪«┘è╪╡', 'Licenses')}
                </h3>
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪▒╪«╪╡╪⌐ ╪º┘ä┘å┘é┘ä ┘ê╪┤┘ç╪º╪»╪⌐ ╪º┘ä╪¬╪ú┘à┘è┘å', 'Transport license & insurance')}
                </p>
              </div>
            </div>
            <FileUploadZone
        ...
        return (
          <div className="space-y-5 animate-fade-in">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="font-semibold text-base">
                  {t(locale, '┘à╪╣┘ä┘ê┘à╪º╪¬ ╪º┘ä╪ú╪│╪╖┘ê┘ä', 'Fleet Information')}
                </h3>
                <p className="text-xs text-muted-foreground">
                  {t(locale, '╪¿┘è╪º┘å╪º╪¬ ╪º┘ä┘à╪▒┘â╪¿╪º╪¬ ┘ê╪º┘ä╪│╪º╪ª┘é┘è┘å', 'Vehicles & drivers data')}
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-sm font-medium">
                  {t(locale, '╪╣╪»╪» ╪º┘ä┘à╪▒┘â╪¿╪º╪¬', 'Number of Vehicles')}
                </Label>
                <Input
                  type="number"
                  min="1"
                  placeholder={t(locale, '┘à╪½╪º┘ä: 5', 'e.g. 5')}
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium">
                  {t(locale, '╪╣╪»╪» ╪º┘ä╪│╪º╪ª┘é┘è┘å', 'Number of Drivers')}
                </Label>
                <Input
                  type="number"
                  min="1"
                  placeholder={t(locale, '┘à╪½╪º┘ä: 8', 'e.g. 8')}
  ...
  const renderReviewStep = () => {
    const getReviewItems = (): { label: string; labelEn: string; done: boolean }[] => {
      switch (role) {
        case 'store_manager':
          return [
            { label: '╪▒┘é┘à ╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è', labelEn: 'Commercial Register Number', done: commercialRegisterNumber.length === 10 },
            { label: '┘ê╪½┘è┘é╪⌐ ╪º┘ä╪│╪¼┘ä ╪º┘ä╪¬╪¼╪º╪▒┘è', labelEn: 'Commercial Register Document', done: !!commercialRegisterFile },
            { label: 'IBAN', labelEn: 'IBAN', done: validateIban(iban, ibanConfig) },
            { label: '╪º╪│┘à ╪º┘ä┘à╪│╪¬┘ü┘è╪»', labelEn: 'Beneficiary Name', done: beneficiaryName.length > 0 },
        ...
        case 'supplier':
          return [
            { label: '╪▒╪«╪╡╪⌐ ╪¬╪¼╪º╪▒┘è╪⌐', labelEn: 'Commercial License', done: !!commercialLicenseFile },
        ...
        case 'logistics':
          return [
            { label: '╪▒╪«╪╡╪⌐ ╪º┘ä┘å┘é┘ä', labelEn: 'Transport License', done: !!transportLicenseFile },
            { label: '╪┤┘ç╪º╪»╪⌐ ╪º┘ä╪¬╪ú┘à┘è┘å', labelEn: 'Insurance Certificate', done: !!insuranceCertificateFile },
            { label: '╪╣╪»╪» ╪º┘ä┘à╪▒┘â╪¿╪º╪¬', labelEn: 'Number of Vehicles', done: Number(numberOfVehicles) > 0 },
            { label: '╪╣╪»╪» ╪º┘ä╪│╪º╪ª┘é┘è┘å', labelEn: 'Number of Drivers', done: Number(numberOfDrivers) > 0 },
          ];
        default:
          return [];
      }
      ...
      <div className="space-y-5 animate-fade-in">
        ...
        <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
          ...
          <p className="text-xs text-amber-700 dark:text-amber-300">
            {t(
              locale,
              '╪¿╪╣╪» ╪º┘ä╪Ñ╪▒╪│╪º┘ä╪î ╪│┘è╪¬┘à ┘à╪▒╪º╪¼╪╣╪⌐ ╪¿┘è╪º┘å╪º╪¬┘â ╪«┘ä╪º┘ä 2-24 ╪│╪º╪╣╪⌐ ╪╣┘à┘ä',
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          >
            {t(locale, '╪º┘ä╪▒╪¼┘ê╪╣ ┘ä┘ä╪¬╪╣╪»┘è┘ä', 'Back to Edit')}
          </Button>
          <Button
          ...
          >
            {isSubmitting ? (
              <>
                ...
                {t(locale, '╪¼╪º╪▒┘è ╪º┘ä╪Ñ╪▒╪│╪º┘ä...', 'Submitting...')}
              </>
            ) : (
              <>
                <Shield className="h-4 w-4 me-2" />
                {t(locale, '╪Ñ╪▒╪│╪º┘ä ┘ä┘ä┘à╪▒╪º╪¼╪╣╪⌐', 'Submit for Review')}
              </>
            )}
          </Button>
        </div>
          ...
          <div className="mx-6 mt-5 flex items-center gap-2.5 p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 animate-fade-in">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-blue-800 dark:text-blue-200">
                {t(locale, '╪¬┘à ╪º╪│╪¬╪╣╪º╪»╪⌐ ╪¿┘è╪º┘å╪º╪¬┘â ╪º┘ä┘à╪¡┘ü┘ê╪╕╪⌐', 'Your saved data has been restored')}
              </p>
              <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">
                {t(locale, '┘è┘à┘â┘å┘â ╪º╪│╪¬┘â┘à╪º┘ä ╪º┘ä╪¿┘é┘è╪⌐ ┘à┘å ╪¡┘è╪½ ╪¬┘ê┘é┘ü╪¬', 'Continue from where you left off')}
              </p>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-lg">
                {t(locale, '╪º┘â╪¬┘à╪º┘ä ╪º┘ä╪¡╪│╪º╪¿', 'Complete Your Account')}
              </h2>
            </div>
            <Button
              variant="ghost"
            ...
            >
              ...
              {t(locale, '╪¡┘ü╪╕ ╪º┘ä┘à╪│┘ê╪»╪⌐ ┘ê╪º┘ä╪«╪▒┘ê╪¼', 'Save Draft & Exit')}
            </Button>
          </div>
          {/* Progress bar */}
