...
function generateNotifications(
  ...
  // ── ADMIN NOTIFICATIONS ──
  // NOTE: Admin verification notifications are NOT generated here anymore.
  // They are added dynamically by the AdminReviewQueue component
  // after fetching real data from /api/admin/review.
  if (role === 'admin') {
    notifications.push({
