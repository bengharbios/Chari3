    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100">
      ...
      <header className="bg-navy text-white h-16 flex items-center justify-between px-6 shadow-md">
        <div className="flex items-center gap-3">
          <Link href="." className="flex items-center gap-2 text-white hover:text-brand transition-colors">
          ...
          <span className="font-bold text-lg">إعدادات المنصة الديناميكية</span>
        </div>
      </header>
