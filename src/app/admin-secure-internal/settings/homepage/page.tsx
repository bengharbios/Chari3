                      ...
                      {currentSlides.map((s, idx) => (
                        <div key={s.id || idx} className={`flex items-center justify-between p-4 transition-colors ${editingSlideIndex === idx ? 'bg-muted/40 border-l-4 border-l-brand' : 'bg-background'}`}>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <Button variant="ghost" size="icon" disabled={idx === currentSlides.length - 1} onClick={() => moveSlide(idx, 'down')} className="rounded-full h-8 w-8">
                              <ChevronDown className="w-4 h-4" />
                            </Button>
                ...
                <CardHeader>
                  <CardTitle className="text-lg font-bold flex items-center gap-1.5">
                    ...
                    {editingSlideIndex !== null
                      ? editingSlideIndex === currentSlides.length
