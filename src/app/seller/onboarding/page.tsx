    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-foreground py-6" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
        <div className="max-w-4xl mx-auto px-4 mb-6">
          <a href="/?page=verification" className="inline-flex items-center text-sm text-gray-500 hover:text-gray-900 dark:text-slate-400 dark:hover:text-slate-200 transition-colors">
