...
const RECENT_ACTIVITY = [
  ...
  { actionAr: 'متجر جديد "عالمتنقل"', actionEn: 'New store "DZ Express"', time: (l: Locale) => l === 'ar' ? 'منذ 15 دقيقة' : '15 min ago', icon: StoreIcon, color: 'text-green-500' },
