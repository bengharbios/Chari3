...
export default function OnboardingWizard() {
  ...
  const stepsList = isBusiness ? [
    { id: 0, title: t('السجل التجاري للشركة', 'Commercial Register'), tabTitle: t('السجل التجاري', 'Register'), icon: <StoreIcon className="w-5 h-5" />, done: hasLegal, component: <LegalStep data={formData} updateData={handleUpdateData} onPreviewFile={setPreviewFileUrl} isBusiness={true} /> },
    { id: 1, title: t('التفاصيل الضريبية للشركة', 'Tax Details'), tabTitle: t('الضرائب', 'Tax'), icon: <FileText className="w-5 h-5" />, done: hasTax, component: <TaxStep data={formData} updateData={handleUpdateData} onPreviewFile={setPreviewFileUrl} isBusiness={true} /> },
    { id: 2, title: t('التوثيق المالي والحساب البنكي', 'Financials'), tabTitle: t('الحساب البنكي', 'Bank'), icon: <Landmark className="w-5 h-5" />, done: hasBank, component: <BankStep data={formData} updateData={handleUpdateData} onPreviewFile={setPreviewFileUrl} isBusiness={true} /> },
