                        ...
                        <>
                          ...
                          {status === 'confirmed' && (
                            <>
                              ...
                              >
                                🖨️ {t('طباعة بوليصة الشحن', 'Print Thermal Slip')}
                              </Button>
                              <Button 
                                size="sm" 
                                variant="destructive" 
                          ...
                          {status === 'shipped' && (
                            <>
                              ...
                              <Button
                                ...
                                onClick={() => handlePrintWaybill(order)}
                              >
                                🖨️ {t('طباعة البوليصة', 'Print Label')}
                              </Button>
                              <Button
                                size="sm"
                                variant="outline"
                                className="rounded-xl font-bold gap-1 text-xs text-amber-600 border-amber-500/30 hover:bg-amber-500/10"
                                onClick={() => handleStatusChange(orderId, 'confirmed')}
                              >
                                ↩️ {t('تراجع (خطأ بالضغط)', 'Revert Status')}
                              </Button>
                              <Button
                                size="sm"
                                variant="outline"
                                className="rounded-xl font-bold gap-1 text-xs"
                                onClick={() => {
                                  window.location.href = '/seller/shipping';
                                }}
                              >
                                📦 {t('متابعة الشحن', 'Track Hub')}
                              </Button>
                              <Button 
                                size="sm" 
                                variant="destructive" 
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 p-3 bg-muted/20 border border-border rounded-xl">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-foreground">{tk('productForm.titleArLabel')}</label>
                  <input
                    type="text"
                    value={name}
                ...
                {isEnActive && (
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-foreground">{tk('productForm.titleEnLabel')}</label>
                    <input
                      type="text"
                      value={nameEn}
                ...
                {isFrActive && (
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-foreground">{tk('productForm.titleFrLabel')}</label>
                    <input
                      type="text"
                      value={nameFr}
              ...
              <div className="grid grid-cols-2 gap-4">
               ...
               {/* ── SECTION 2: PRODUCT FEATURES (BULLET POINTS) ── */}
              <div className="space-y-4 p-3.5 bg-muted/20 border border-border rounded-xl">
                {/* Arabic Bullets */}
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                ...
                {isFrActive && (
                  <div className="space-y-2 pt-2 border-t border-border/50">
                    <div className="flex items-center justify-between">
                      <label className="text-xs font-bold text-foreground">{tk('productForm.featuresFrLabel')}</label>
                      <button
                        type="button"
                        onClick={() => {
              ...
              {/* ── SECTION 3: DETAILED DESCRIPTIONS ── */}
              <div className="space-y-3 p-3.5 bg-muted/20 border border-border rounded-xl">
                ...
                {isFrActive && (
                  <div className="space-y-1.5 pt-2 border-t border-border/50">
                    <label className="text-xs font-bold text-foreground">{tk('productForm.descriptionFrLabel')}</label>
                    <textarea
                      value={descriptionFr}
